...
class MultiClassDataLoader(object):
    ...
    def define_flags(self):
        self.__flags.DEFINE_string("train_data_file", "/content/drive/My Drive/fininsight/21대 총선분석/Text Classification/TextCNN/cnn-text-classification-tf/data/kkk.train", "Data source for the training data.")
        self.__flags.DEFINE_string("dev_data_file", "/content/drive/My Drive/fininsight/21대 총선분석/Text Classification/TextCNN/cnn-text-classification-tf/data/kkk.dev", "Data source for the cross validation data.")
        self.__flags.DEFINE_string("class_data_file", "/content/drive/My Drive/fininsight/21대 총선분석/Text Classification/TextCNN/cnn-text-classification-tf/data/kkk.cls", "Data source for the class list.")
    ...
    def prepare_data(self):
        ...
        max_doc_len = max([len(doc) for doc in x_train]) # .decode("utf-8")
        max_doc_len_dev = max([len(doc) for doc in x_dev]) # .decode("utf-8")
