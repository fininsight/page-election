...
class SVDEmbedding(Embedding):
    ...
    def __init__(self, path, normalize=True, eig=0.0, **kwargs):
        ...
        ut = np.load(path + 'politic_news_100000_mincount50_svd.ut.npy').T
        s = np.load(path + 'politic_news_100000_mincount50_svd.s.npy')
        vocabfile = path + 'politic_news_100000_mincount50_svd_inputvoca.pkl'
